...
<body class="index-body d-flex flex-column" style="min-height: 100vh">
  <div class="index-wrap">
      <div class="content">
          ...
          <h1 class="index-title">勞動部<br>僱用管理就業平等概況調查</h1>
          <span>資料時間:中華民國111年9月</span>
          <br>
          <div class="info-box text-left">
            <span>為了解事業單位對勞工之僱用管理實況及性別工作平等法實施現況，作為推動相關業務及制定政策之參考，特委託故鄉市場調查股份有限公司辦理「僱用管理就業平等概況調查」，敬請惠予撥冗填答。請於收到調查表後<span class="text-danger">一星期內</span>填妥調查表。</span>
            <br>
  ...
  <footer class="footer">
    <ul class="footer-info">
        <li>核定機關：行政院主計總處 ｜ </li>
        <li>核定文號：主普管字第1100400907 號 ｜ </li>
        <li>調查類別：一般統計調查 ｜ </li>
        <li>有效期間：至民國112 年12月底止</li>
    </ul>
    <ul class="footer-info">
